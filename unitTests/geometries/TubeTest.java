...
//
//
//// Test case where the ray intersects the tube at one point
//        Ray ray2 = new Ray(new Point(1, 0, 0), new Vector(0, 0, 1));
//        List<Point> result2 = tube.findIntersections(ray2);
//        assertEquals(1, result2.size(), "Ray should intersect the tube at one point");
//        assertEquals(new Point(1, 0, 0), result2.get(0), "Intersection point is incorrect");
//
...
//        assertEquals(new Point(0, 0, 1), result3.get(0), "Intersection point is incorrect");
//    }
}
