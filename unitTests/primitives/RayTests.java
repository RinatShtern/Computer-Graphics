...
class RayTests {
    ...
    void testGetPoint() {
        ...
        assertEquals(new Point(1 + 1/Math.sqrt(3), 1 + 1/Math.sqrt(3), 1 + 1/Math.sqrt(3)), r1.getPoint(1), "Bad point");

        // TC02: point is not in the middle of the ray
        Ray r2 = new Ray(new Point(1, 1, 1), new Vector(1, 1, 1));
        assertEquals(new Point(1 + 2/Math.sqrt(3), 1 + 2/Math.sqrt(3), 1 + 2/Math.sqrt(3)), r2.getPoint(2), "Bad point");
